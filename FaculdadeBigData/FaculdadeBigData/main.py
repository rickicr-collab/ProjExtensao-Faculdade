...
def analisar_dados(mes, ano, janela_analise):
    def analisar_dados(mes, ano, janela_analise):
        try:
            ...
            required_columns = ['Nome', 'Estoque Inicial', 'Preço Unitário', 'Quantidade Vendida',
                                'Bebidas faltantes ou vencidas']
            ...
            # Identifica o produto mais vendido e menos vendido
            produto_mais_vendido = df.loc[df['Quantidade Vendida'].idxmax()]
            produto_menos_vendido = df.loc[df['Quantidade Vendida'].idxmin()]
            ...
            messagebox.showinfo(
                ...
                f'Produto Mais Vendido: {produto_mais_vendido["Nome"]} com {produto_mais_vendido["Quantidade Vendida"]} unidades vendidas.\n'
                f'Produto Menos Vendido: {produto_menos_vendido["Nome"]} com {produto_menos_vendido["Quantidade Vendida"]} unidades vendidas.'
            )
